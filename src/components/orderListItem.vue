<template>
  <div class="order-list-item">
    ...
    <div class="list" v-for="good in item.goods" :key="good.goods_id">
      <div class="list-item">
        <div class="goods-img">
    ...
    <div class="actions">
      <div v-if="item.order_status === 10">
        ...
        <span
          v-else-if="item.delivery_status === 10"
...
<script>
import { postCancelOrder } from "@/api/order";
export default {
  name: "OrderListItem",
  props: {
    item: {
  ...
  methods: {
    cancelOrder(order_id) {
      this.$dialog
        ...
        .then(async () => {
          await postCancelOrder(order_id);
        })
        .catch(() => {});
    },
  },
